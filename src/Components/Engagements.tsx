            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th className="border-2 text-center">Client Name</th>
                        <th className="border-2 text-center">Audit Type</th>
                        <th className="border-2 text-center">Status</th>
                        <th className="border-2 text-center">Start Date</th>
                        <th className="border-2 text-center">End Date</th>
                ...
                <tbody>
                    {props?.tableArray?.map((item: any, index: any) => (
                        <tr key={index}>
                            ...
                            <td className="border-2 text-center">{item.auditName}</td>
                            <td className="border-2 text-center">{item.auditStatus}</td>
                            <td className="border-2 text-center">{item.engagementStartDate}</td>
                            <td className="border-2 text-center">{item.engagementEndDate}</td>
                            <td className="border-2 text-center cursor-pointer">
